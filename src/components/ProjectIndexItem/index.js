            ...
            <div className="pj-window">
                ...
                <div className="pj-body">
                    ...
                    <div className="links-container">
                        <a href={codeSrc} target="_blank" className="icons pj-links" rel="noreferrer">Code</a> <a href={liveSrc} target="_blank" className="icons pj-links" rel="noreferrer">Demo</a>
                    </div>

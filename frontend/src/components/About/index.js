                    ...
                    <div className="uses">
                        ...
                        <h3>I also use:</h3>
                            <ul className="about-list">
                                ...
                                <li><img src="https://derailed-seed.s3.us-west-1.amazonaws.com/3js.png" width={'16px'} height={'16'}  alt="Three.js Logo"/> <a href="https://threejs.org/" target="_blank" rel="noreferrer"> Three.js </a> - 3d Graphics Library </li>
                                <li><img src="https://derailed-seed.s3.us-west-1.amazonaws.com/hygraph.png" width={'16px'} height={'16'} alt="Hygraph Logo"/> <a href="https://hygraph.com/" target="_blank" rel="noreferrer" > Hygraph </a> - Headless CMS </li>
                                <li><img src="https://derailed-seed.s3.us-west-1.amazonaws.com/postgres.png" width={'16px'} height={'16'} alt="PostgresQL Logo"/> <a href="https://hygraph.com/" target="_blank" rel="noreferrer" > PostgresQL </a> - Relational Database </li>
                                <li><img src="https://derailed-seed.s3.us-west-1.amazonaws.com/rails.png" width={'16px'} height={'16'} alt="Rails Logo" />  <a href="https://rubyonrails.org/" target="_blank" rel="noreferrer" > Ruby on Rails </a> - Backend Web Application Framwork </li>
                            </ul>
                        ...
                        <h3>Tools:</h3>
                            <ul className="about-list">
                                ...
                                <li><img src="https://derailed-seed.s3.us-west-1.amazonaws.com/nts.png" width={'16px'} height={'16'} alt="NTS Logo"/> <a href="https://www.nts.live/" target="_blank" rel="noreferrer"> NTS </a> - Pirate Radio </li>
                                <li><img src="https://derailed-seed.s3.us-west-1.amazonaws.com/paletton.png" width={'16px'} height={'16'} alt="Paletton"/> <a href="https://paletton.com/" target="_blank" rel="noreferrer"> Paletton </a> - Color Scheme Designer </li>
                                <li><img src="https://derailed-seed.s3.us-west-1.amazonaws.com/anki.png" width={'16px'} height={'16'} alt="Anki Logo"/> <a href="https://apps.ankiweb.net/" target="_blank" rel="noreferrer"> Anki </a> - Open-Source Flashcard Program </li>
                                <li><img src="https://derailed-seed.s3.us-west-1.amazonaws.com/obsidian.png" width={'16px'} height={'16'} alt="Obsidian Logo"/> <a href="https://obsidian.md/" target="_blank" rel="noreferrer"> Obsidian </a> - Note Taking Application</li>
                                <li><img src="https://derailed-seed.s3.us-west-1.amazonaws.com/to-do.png" width={'16px'} height={'16'} alt="To Do Logo"/> <a href="https://todo.microsoft.com/tasks/" target="_blank" rel="noreferrer"> Microsoft To Do </a> - To Do list  </li>
